...
Vectorfield
by Unexex based on Rayfield

bitsplicer | Vectorfield | Designing + Programming
shlex      | Rayfield    | Designing + Programming
iRay       | Rayfield    | Programming
...
local VectorfieldLibrary = {
	Flags = {},
	Theme = {
		Default = {
			TextFont = "Default", -- Default will use the various font faces used across Vectorfield
...
for _, Interface in ipairs(StarterGui:GetChildren()) do
	if Interface.Name == Vectorfield.Name and Interface ~= Vectorfield then
		Interface.Enabled = false
		Interface.Name = "Vectorfield-Old"
	end
end
...
local Main = Vectorfield.Main
local Topbar = Main.Topbar
local Elements = Main.Elements
local LoadingFrame = Main.LoadingFrame
local TabList = Main.TabList

Vectorfield.DisplayOrder = 100
...
local Notifications = Vectorfield.Notifications

local SelectedTheme = VectorfieldLibrary.Theme.Default

function ChangeTheme(ThemeName)
	SelectedTheme = VectorfieldLibrary.Theme[ThemeName]
	for _, obj in ipairs(Vectorfield:GetDescendants()) do
	...
	Vectorfield.Main.BackgroundColor3 = SelectedTheme.Background
	Vectorfield.Main.Topbar.BackgroundColor3 = SelectedTheme.Topbar
	Vectorfield.Main.Topbar.CornerRepair.BackgroundColor3 = SelectedTheme.Topbar
	Vectorfield.Main.Shadow.Image.ImageColor3 = SelectedTheme.Shadow

	Vectorfield.Main.Topbar.ChangeSize.ImageColor3 = SelectedTheme.TextColor
	Vectorfield.Main.Topbar.Hide.ImageColor3 = SelectedTheme.TextColor
	Vectorfield.Main.Topbar.Theme.ImageColor3 = SelectedTheme.TextColor
...
function VectorfieldLibrary:Notify(NotificationSettings)
	spawn(function()
		...
		if NotificationSettings.Actions then
			for _, Action in pairs(NotificationSettings.Actions) do
				...
				if SelectedTheme ~= VectorfieldLibrary.Theme.Default then
				...
				NewAction.MouseButton1Click:Connect(function()
					...
					if not Success then
						print("Vectorfield | Action: "..Action.Name.." Callback Error " ..tostring(Response))
					end
...
function VectorfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "Vectorfield Interface Suite"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by Sirius"
	if Settings.LoadingTitle ~= "Vectorfield Interface Suite" then
		LoadingFrame.Version.Text = "Vectorfield UI"
	end
	...
	function Window:CreateTab(Name,Image)
		...
		function Tab:CreateButton(ButtonSettings)
			...
			Button.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("Vectorfield | "..ButtonSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Button.Title.Text = ButtonSettings.Name
		...
		function Tab:CreateBanner(BannerSettings)
			...
			local Banner = Elements.Template.Banner:Clone()
			Banner.Name = BannerSettings.Name
			Banner.Title.Text = BannerSettings.Name
			Banner.Layer.Contents.Text = BannerSettings.Content
			Banner.Thumbnail.Image = BannerSettings.Image
			Banner.Visible = true
			Banner.Parent = TabPage

			Banner.BackgroundTransparency = 1
			Banner.UIStroke.Transparency = 1
			Banner.Title.TextTransparency = 1

			TweenService:Create(Banner, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {BackgroundTransparency = 0}):Play()
			TweenService:Create(Banner.UIStroke, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
			TweenService:Create(Banner.Title, TweenInfo.new(0.7, Enum.EasingStyle.Quint), {TextTransparency = 0}):Play()	
			...
			Button.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					TweenService:Create(Button.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					Button.Title.Text = "Callback Error"
					print("Vectorfield | "..BannerSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Button.Text = BannerSettings.ButtonName
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Button.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0.85}):Play()
				else
					TweenService:Create(Button, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackgroundHover}):Play()
					TweenService:Create(Button.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 1}):Play()
					task.wait(0.2)
		...
		function Tab:CreateInput(InputSettings)
			...
			Input.InputFrame.InputBox.FocusLost:Connect(function()
				...
				if not Success then
					...
					print("Vectorfield | "..InputSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Input.Title.Text = InputSettings.Name
			...
			for _, Option in ipairs(DropdownSettings.Options) do
				...
				DropdownOption.Interact.MouseButton1Click:Connect(function()
					...
					if not Success then
						...
						print("Vectorfield | "..DropdownSettings.Name.." Callback Error " ..tostring(Response))
						task.wait(0.5)
						Dropdown.Title.Text = DropdownSettings.Name
						TweenService:Create(Dropdown, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
		...
		function Tab:CreateKeybind(KeybindSettings)
			...
			UserInputService.InputBegan:Connect(function(input, processed)
				...
				if CheckingForKey then
					if input.KeyCode ~= Enum.KeyCode.Unknown and input.KeyCode ~= Enum.KeyCode[Settings.OpenKey] then
				...
				elseif KeybindSettings.CurrentKeybind ~= nil and (input.KeyCode == Enum.KeyCode[KeybindSettings.CurrentKeybind] and not processed) then -- Test
					...
					if not KeybindSettings.HoldToInteract then
						...
						if not Success then
							...
							print("Vectorfield | "..KeybindSettings.Name.." Callback Error " ..tostring(Response))
							task.wait(0.5)
							Keybind.Title.Text = KeybindSettings.Name
							TweenService:Create(Keybind, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
		...
		function Tab:CreateToggle(ToggleSettings)
			...
			Toggle.Interact.MouseButton1Click:Connect(function()
				...
				if not Success then
					...
					print("Vectorfield | "..ToggleSettings.Name.." Callback Error " ..tostring(Response))
					task.wait(0.5)
					Toggle.Title.Text = ToggleSettings.Name
					TweenService:Create(Toggle, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
					TweenService:Create(Toggle.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {Transparency = 0}):Play()
					...
					if Dragging then
						...
						if SliderSettings.CurrentValue ~= NewValue then
							...
							if not Success then
								...
								print("Vectorfield | "..SliderSettings.Name.." Callback Error " ..tostring(Response))
								task.wait(0.5)
								Slider.Title.Text = SliderSettings.Name
								TweenService:Create(Slider, TweenInfo.new(0.6, Enum.EasingStyle.Quint), {BackgroundColor3 = SelectedTheme.ElementBackground}):Play()
...
function VectorfieldLibrary:Destroy()
	Vectorfield:Destroy()
end
...
UserInputService.InputBegan:Connect(function(input, processed)
	if OpenKey and (input.KeyCode == Enum.KeyCode[OpenKey or "Unknown"] and not processed) then
		if Debounce then return end
		if Hidden then
			Hidden = false
			Unhide()
...
VectorfieldLibrary.ChangeTheme = ChangeTheme

return VectorfieldLibrary
